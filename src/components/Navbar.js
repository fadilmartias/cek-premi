      ...
      <nav className="border-b-2">
        <div className="container mx-auto px-5 xl:px-32">
          <div className="flex items-center justify-between py-5">
            ...
            <button className="hidden md:flex px-4 py-2 rounded-lg bg-blue-500 hover:bg-blue-600 capitalize text-white font-semibold" onClick={() => window.open("https://wa.me/6281918880181")}>
              Chat with us
            </button>
          </div>
          <ul
